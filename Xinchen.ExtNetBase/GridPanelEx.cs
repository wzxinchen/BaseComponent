namespace Xinchen.ExtNetBase
{
    ...
    [ToolboxData("<{0}:GridPanelEx runat=server></{0}:GridPanelEx>"), DefaultProperty("Text")]
    public class GridPanelEx : GridPanel
    {
        ...
        [Description("指定编辑方式"), PersistenceMode(PersistenceMode.InnerProperty), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), ConfigOption("editorConfig", JsonMode.Object), Meta, Category("2. Observable"), NotifyParentProperty(true)]
