...
namespace ChinhDo.Transactions
{
    ...
    public class TxFileManager : IFileManager
    {
        ...
        public void MoveFolder(string srcFolderName,string destFolderName)
        {
            if (IsInTransaction())
            {
                EnlistOperation(new FolderMoveOperation(srcFolderName, destFolderName));
            }
            else
            {
                Directory.Move(srcFolderName, destFolderName);
            }
        }
